...
namespace SimplExModel.Model.Inherited
{
    public class FiveStepMarkSystem : MarkSystem
    {
        ...
        {
            string result = $"5 баллов: {FivePercent}% верного выполнения;" + Environment.NewLine +
                $"4 баллов: {FourPercent}% верного выполнения;" + Environment.NewLine +
                $"3 баллов: {ThreePercent}% верного выполнения;" + Environment.NewLine +
                $"2 баллов: {TwoPercent}% верного выполнения;" + Environment.NewLine +
                $"1 баллов: {OnePercent}% верного выполнения.";
            return result;
        }
